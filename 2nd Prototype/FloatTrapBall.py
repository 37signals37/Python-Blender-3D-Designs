...
def floatTrapDesigns():
    ...
    ball.name = "ball"
    bpy.ops.transform.translate(value=(0, 0, baseD), constraint_axis=(False, False, True), constraint_orientation='GLOBAL', mirror=False, proportional='DISABLED', proportional_edit_falloff='SMOOTH', proportional_size=1)
